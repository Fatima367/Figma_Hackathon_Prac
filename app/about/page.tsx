  ...
  return (
    <div className="">
      <main className="flex flex-col">
        ...
        <div className="mt-36 flex justify-between mx-auto space-x-7 mb-36 px-10">
          <div
          ...
          >
            <div className="flex flex-col space-y-6 items-center justify-center">
              ...
              <div className="space-y-3 flex flex-col items-center justify-center">
                ...
                <p className="text-base ">Sellers active our site</p>
              </div>
            </div>
          </div>

          <div
            className="flex flex-col items-center justify-center rounded shadow-md bg-[#DB4444]
             w-60 h-56 text-white"
          >
            <div className="flex flex-col space-y-6 items-center justify-center">
              <Image
              ...
              <div className="space-y-3 flex flex-col items-center justify-center">
                ...
                <p className="text-base ">Monthly Produduct Sale</p>
              </div>
            </div>
          </div>
        ...
        <div className="flex space-x-7 mb-36 justify-between px-10">
          <div className="space-y-8 flex flex-col">
            <div className="bg-[#F5F5F5] w-[20rem] flex items-baseline justify-center">
              <Image
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="space-x-4 flex items-start justify-start">
                <Image
                  src="/images/Icon-Twitter2.png"
                  height={24}
                  width={24}
                  alt="Icon-Twitter2"
                />
                <Image
                  src="/images/icon-instagram2.png"
                  height={24}
                  width={24}
                  alt="icon-instagram2"
                />
                <Image
                  src="/images/Icon-Linkedin2.png"
                  height={24}
                  width={24}
                  alt="Icon-Linkedin2"
                />
          ...
          <div className="space-y-8 flex flex-col">
            <div className="bg-[#F5F5F5] w-[22rem] flex items-baseline justify-center">
              <Image
                src="/images/willsmith.png"
                width={326}
                height={392}
                alt="will-smith"
                className="mt-8"
